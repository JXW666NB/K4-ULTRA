...
基于 [编程猫 Kitten4](https://kitten4.codemao.cn) <a href="https://kitten4.codemao.cn" target="_blank">编程猫 Kitten4(新标签页打开)</a> 源码编辑器的深度定制版本，面向专业游戏开发场景。
...
│   ├── Blink扩展开发指南.md
│   ├── AI编程提示词.md
|   ├── K4编辑器完整功能拆解.md    #K4功能拆解总结
|   ├── architecture/             #K4功能拆解分区
|       ├── 01-分层架构设计.md
|       ├── 02-启动流程详解.md
|       ├── 03-双层执行架构.md
|       ├── 04-核心模块组织.md
...
详细开发指南见 [docs/K4魔改开发手册.md](docs/K4魔改开发手册.md)。
